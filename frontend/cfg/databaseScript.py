...
cursor.execute("CREATE TABLE users(id INT AUTO_INCREMENT PRIMARY KEY, age INT, gender VARCHAR(20), lat DECIMAL(10, 8) NOT NULL, lng DECIMAL(11, 8) NOT NULL, user_result INT)")
